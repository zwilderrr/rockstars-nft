				...
				<div class="row">
					<div class="col-12">
						...
						<p class="terms-description">
							Mutant Ape Yacht Club is a collection of digital artworks (NFTs)
							...
							as the Mutant Ape Yacht Club smart contract runs on the Ethereum
						...
						<p class="terms-description">
							...
							involving Mutant Ape Yacht Club digital collectibles.
						</p>
						<h2>1. Ownership</h2>
						<p class="terms-description">
							A. You Own the NFT. Each Mutant Ape is an NFT on the Ethereum
							blockchain. When you purchase an NFT, you own the underlying
							Mutant Ape, the Art, completely. Ownership of the NFT is mediated
						...
						<p class="terms-description">
							...
							Terms, Yuga Labs LLC grants you a worldwide, royalty-free license
							...
							of your Mutant Ape / NFT, provided that the marketplace
							cryptographically verifies each Mutant Ape owner’s rights to
							display the Art for their Mutant Ape to ensure that only the
							actual owner can display the Art; or (iii) as part of a third
							party website or application that permits the inclusion,
							involvement, or participation of your Mutant Ape, provided that
							the website/application cryptographically verifies each Mutant Ape
							owner’s rights to display the Art for their Mutant Ape to ensure
							that only the actual owner can display the Art, and provided that
							the Art is no longer visible once the owner of the Mutant Ape
						...
						<p class="terms-description">
							...
							verifies each Mutant Ape owner’s rights to display the Art for
							their Mutant Ape to ensure that only the actual owner can display
							the Art; (ii) owning or operating a third party website or
							application that permits the inclusion, involvement, or
							participation of Mutant Apes generally, provided that the third
							party website or application cryptographically verifies each
							Mutant Ape owner’s rights to display the Art for their Mutant Ape
							...
							Purchased Mutant Ape leaves the website/application; or (iii)
							earning revenue from any of the foregoing.
						</p>
						<p class="terms-description">
							D. MAYC/BAYC IP.&nbsp; Other than the rights to the Art, nothing
							herein gives you any rights to any other trademarks or other
							intellectual property rights belonging to Yuga Labs including,
							without limitation, to Bored Ape Yacht Club, BAYC, Bored Ape
							Kennel Club, BAKC, Mutant Ape Yacht Club, MAYC, and the associated
							logos. All of these rights are expressly reserved in the name of
							Yuga Labs LLC.
						</p>
						<p class="terms-description">
						...
						<p class="terms-description">
							A. If you elect to purchase a Mutant Ape through the Site, any
						...
						<p class="terms-description">
							A. To the extent that you sell your Mutant Ape NFT, please be
							aware that the prices of NFTs are extremely volatile and
							fluctuations in the prices of other NFTs and impact the price of
							your Mutant Ape both positively and negatively.&nbsp; Given the
							volatility, NFTs such as Mutant Ape should not be considered an
							investment.&nbsp;You assume all risks in that connection.
						</p>
						<p class="terms-description">
							B. Ownership of a Mutant Ape confers ownership of digital artwork
							...
							nature of the project, MAYC has not been registered with or
							approved by any regulator in any jurisdiction. It remains your
							sole responsibility to assure that the purchase of the Mutant Ape
						...
						<p class="terms-description">
							...
							the value for your Mutant Ape.&nbsp;You understand and accept all
							risk in that regard.
						</p>
						<p class="terms-description">
						...
						<p class="terms-description">
							You agree to hold harmless and indemnify MAYC and its
						...
						<p class="terms-description">
							...
							18 years old to access this Site or purchase a Mutant Ape. If you
